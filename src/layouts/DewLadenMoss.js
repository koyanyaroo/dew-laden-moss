        ...
        <>
            <div>
                ...
                <div className="hidden md:flex md:w-60 md:flex-col md:fixed md:inset-y-0 ">
                    ...
                    <div className="flex flex-col flex-grow border-r border-brand/10 pt-4 bg-white overflow-y-auto">
                        <div className="flex items-center flex-shrink-0 px-6 space-x-2">
                            <svg className="w-8 h-8" style={{"shapeRendering":"geometricPrecision","textRendering":"geometricPrecision","imageRendering":"optimizeQuality","fillRule":"evenodd","clipRule":"evenodd"}} viewBox="0 0 1270 1270" xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve">
                                <defs/>
                                <g id="Layer_x0020_1">
                                    <g id="_2763128350256">
                                        <rect height="1270" style={{"fill":"#8a9b37"}} width="1270" rx="130.17" ry="147.47"/>
                            ...
                            <div className="font-semibold text-sm">Dew Laden Moss</div>
                        </div>
